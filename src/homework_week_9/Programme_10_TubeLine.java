...
public class Programme_10_TubeLine {
    public static void main(String[] args) {
        ...
        String[] tubeStationZone1 = new String[]{"Aldgate", "Aldgate East",
                "Angle", "Backer Street", "Bank", "Barbican", "BabyWater", "Blackfriars",
                "Bond Street", "Borough", "Cannon Street", "Chancery Lane",
                "Charing Cross", "Covent Garden", "Earl'sCourt",
                "Edgware Road", "Elephant & Castle", "Embankment", "Euston",
                "Euston Square", "Farringdon", "Gloucester Road",
                "Goodge Street", "Great Portland Street", "Green Park", "High Street Kensington",
                "Holborn", "Hyde Park Corner", "King's Cross",
                "KInghtsbridge", "Lambeth North", "Lancaster gate", "Leicester Square",
                "LiverPool Street", "London Bridge", "Mansion House",
                "Marble Arch", "MaryLebone", "Monument", "Moorgate", "Notting Hill Gate",
                "Old Street", "Oxford Circus", "Paddington",
                "Piccadilly Circus", "Pimlico", "Queenway", "Regent's Park",
                "Russell Square", "Sloane Square",
                "South Kensington", "St Pancras", "St.Paul s", "Temple",
                "Tottenham Court Road", "Tower GateWay",
                "Tower Hill", "Vauxhall", "Victoria", "Warren Street", "Waterloo East",
        ...
        londonUGLines[5][0] = "Jubille Line";
        ...
        londonUGLines[8][9] = "Kinghtsbridge";
        londonUGLines[8][10] = "Rusell Square";
            ...
            for (int x = 0; x < londonUGLines.length; x++) {
                for (int y = 1; y < tubeStationZone1.length; y++) {
                    ...
                    if (userTubeStation.equalsIgnoreCase(match)) {
                        System.out.println(londonUGLines[x][0]);//first elements of multi dimension array the line name
                    }
                }
            }
        } else {
