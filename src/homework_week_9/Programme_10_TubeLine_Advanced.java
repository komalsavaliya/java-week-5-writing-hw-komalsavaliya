...
public class Programme_10_TubeLine_Advanced {
    public static void main(String[] args) {
        ...
        String station[] = ("Aldgate, Angle,Baker street, Bank, Barbican, baywater,blackfriars,bond street," +
                "Edgware road,elephant & castle,embankment,euston square," +
                "Farringdon,gloucter road, Goodgs street, Great portland street, green park").split(",");
        ...
        String b;
        //Using do while loop for anothr try from user to input correct station
        do {
            ...
            String str = JOptionPane.showInputDialog(frame, "Enter stationName Between A to G?", "Station Name", JOptionPane.WARNING_MESSAGE);
            String c = "";
